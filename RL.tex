...
% command for add the item to the table of content, each item is a subsection
\newcommand{\ItemTitle}[2]{\hypertarget{#1}{\addcontentsline{toc}{subsection}{#2}\subsection*{#2}}} 
...
\renewcommand{\cfttoctitlefont}{\fontsize{18}{22}\usefont{OT1}{qpl}{m}{n}\selectfont}
...
\renewcommand{\cftsubsecfont}{\fontsize{8}{10}\usefont{OT1}{qpl}{m}{n}\selectfont}
\renewcommand{\cftsubsecpagefont}{\fontsize{8}{10}\usefont{OT1}{qpl}{m}{n}\selectfont}

% reduce the sep of the dot in toc
\renewcommand{\cftsubsecdotsep}{1}


\begin{document}
\title{\bf Notes on Reinforcement Learning}
\author{Ermo Wei}
\date{}
