...
Activation Function are important for neural network to have non-linearity. The commonly used activation function are summarize below. Most of them are typically combined with an affine transformation $\matr{a} = \matr{b} + \matr{W}\matr{x}$ and applied element-wise.
\[
